...
public abstract class QuickAdapter<T> extends BaseQuickAdapter<T, BaseAdapterHelper>
{
     ...
     */
    public QuickAdapter(Context context, List<T> data, int layoutResId)
    {
        super(context, data, layoutResId);
    }

    protected BaseAdapterHelper getAdapterHelper(int position, View convertView, ViewGroup parent, int layoutResId)
    {
